...
node = sx126x.sx126x(serial_num = "/dev/ttyS0",freq=868,addr=0,power=22,rssi=True,air_speed=19200,relay=False)
...
try:
    ...
    while True:
        ...
        if chunks:
            for chunk in chunks:
                print("message is " + str(chunk), end='\r\n')
